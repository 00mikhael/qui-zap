...
const QuestionImage = ({questionImage, quizImage}) => {
  return (
    <span className={`${styles.filter}  col-span-full md:col-start-1 md:col-end-3 md:row-start-2 mb-6 md:mr-6 md:mb-0 justify-self-center md:justify-self-start`} >
      <div style={{flexBasis: "13rem", width: "16rem", height: "auto"}} className={`flex-grow h-80 xl:flex-none bg-fuchsia-200 shadow-md hover:shadow-md rounded-md overflow-hidden mt-4 flex justify-center relative ${styles.shape}`}>
        {
