...
const QuizItem = ({quiz, onAction, noFlex}) => {
  ...
  return (
    <Link onClick={onAction} style={{flexBasis: "12.5rem", width: "12.5rem", height: "auto"}} className={`${styles.item} flex-grow ${noFlex && `sm:flex-none`} h-80 m-2 sm:mb-0 bg-fuchsia-200 cursor-pointer shadow-md hover:shadow-md rounded-lg overflow-hidden flex justify-center relative`} to="/play">
      {
