...
const StartButton = () => {
  return (
    <button className={`justify-self-end col-start-3 row-start-1 rounded max-w-min px-6 py-2 cursor-pointer border border-fuchsia-600 text-fuchsia-600 hover:bg-fuchsia-600 hover:text-white font-medium m-6 z-10`}>Start</button>
  );
}
...
const QuizTitleDescription = ({title, description, creator}) => {
  ...
  return (
    <div className={`flex flex-col space-y-2 col-start-1 col-end-4 row-start-4 mb-24 m-6 z-10`}>
